  ...
  return (
    <>
      <Helmet>
        ...
        {previousPagePath ? (
          <link rel="prev" href={pageContext.previousPagePath} />
        ) : null}
        {nextPagePath ? (
          <link rel="next" href={pageContext.nextPagePath} />
        ) : null}
        ...
        {config.creator.twitter ? (
          <meta name="twitter:creator" content={config.creator.twitter} />
        ) : null}
