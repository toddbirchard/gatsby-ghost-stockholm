              ...
              {navigation.map((navItem, i) => {
                if (navItem.url.includes(`/rss`)) {
                  ...
                  return (
                    <Link
                      key={i}
                      className={`footer-navigation-link ${navItem.label}`}
                  ...
                  return (
                    <a
                      className="footer-navigation-link donate"
                      href={navItem.url}
                      key={i}
                      target="_blank"
                      rel="noopener noreferrer"
