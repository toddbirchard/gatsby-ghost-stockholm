...
const AuthorTrendingWidget = ({ authorData }) => {
  const topPages = authorData.authorTrendingPosts.edges

  return (
    <div className="widget trending">
      <div className="widget-header">
        <div className="label trending"><FontAwesomeIcon icon={[`fas`, `chart-line`]} size="xs" /> <span>Trending</span></div>
...
AuthorTrendingWidget.propTypes = {
  authorData: PropTypes.shape({
    authorTrendingPosts: PropTypes.object.isRequired,
  }).isRequired,
}

export default AuthorTrendingWidget
