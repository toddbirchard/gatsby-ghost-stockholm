  ...
  return (
    <>
      <div className="widget social">
        ...
        <a href={ config.social.feedly } className="rss" key="rss-sidebar" target="_blank" rel="noopener noreferrer"><button aria-label="rss"><FontAwesomeIcon icon={[`fad`, `rss-square`]} size="xs" /></button></a>
      </div>
    </>
  )
}
