                  ...
                  <Link to={`/${ node.slug }`} className="related-post-card" key={`${ node.slug }-related-post`}>
                      ...
                      <div className="related-post-info">
                          ...
                          <div className="related-post-tags">
                              <FontAwesomeIcon icon={[`fad`, `tags`]} swapOpacity /><Tags post={node} limit={2} visibility="public" autolink={false} classes="tag" separator=", " separatorClasses={`${node.ghostId} tag-separator`}/>
                          </div>
                      </div>
                  </Link>
              ))}
